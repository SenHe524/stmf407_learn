...
#define EC_SMENABLEMASK 0xfffeffff
    ...
    struct ecx_context
    {
        ...
        uint16 DCtO;// DC:分布式时钟
        /** internal, length of DC datagram */
        uint16 DCl;
        /** reference to last DC time from slaves */
        int64 *DCtime;
        /** internal, SM buffer */ // SM：同步管理器
        ec_SMcommtypet *SMcommtype;
        /** internal, PDO assign list */ // PDO:过程数据
        ec_PDOassignt *PDOassign;
        /** internal, PDO description list */
        ec_PDOdesct *PDOdesc;
        /** internal, SM list from eeprom */
        ec_eepromSMt *eepSM; // 从机EEPROM中的SM列表
        /** internal, FMMU list from eeprom */ //FMMU:现场总线存储管理单元
        ec_eepromFMMUt *eepFMMU;// 从机EEPROM中的FMMU列表
        /** registered FoE hook */
